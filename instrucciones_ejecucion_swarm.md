...
- **Health Checks:** Desde cualquier host, `curl http:
- **Estado del Cluster:** `curl http:
- **Archivos en Nodo:** `curl http:
- **Leader Proxy (integrado en frontend):** `curl http:


- Sube archivos via POST a `http:
